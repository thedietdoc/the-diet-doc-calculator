        ...
        <div class="col">
            ...
            <table border="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <select id="heightF" name="heightF">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="activity" value="0" checked> 0 (none)<br>
                        <input type="radio" name="activity" value="1"> 1 (1-2 days)<br>
                        <input type="radio" name="activity" value="2"> 2 (3-4 days)<br>
                        <input type="radio" name="activity" value="3"> 3 (5-7 days)<br>
